	...
	<form class="layui-form layui-form-pane">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
		      <input type="text" id="name" autocomplete="off" value="${installPos.name }" placeholder="请输入位置名称" class="layui-input">
	    </div>
	  </div>
