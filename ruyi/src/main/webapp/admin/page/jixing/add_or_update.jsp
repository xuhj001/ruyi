	...
	<form class="layui-form layui-form-pane">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
		      <input type="text" id="name" autocomplete="off" value="${jixing.name }" placeholder="请输入机型名称" class="layui-input">
	    </div>
	  </div>
