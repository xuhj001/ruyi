...
<div style="padding: 10px; overflow: hidden;">
	<form class="layui-form layui-form-pane">
	  ...
	  <div class="layui-form-item">
	    <label class="layui-form-label">水源名称</label>
	    <div class="layui-input-block">
		      <input type="text" id="name" autocomplete="off" value="${shuiyuan.name }" placeholder="请输入水源名称" class="layui-input">
	    </div>
	  </div>
