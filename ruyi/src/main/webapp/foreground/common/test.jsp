...
function go(){
	window.location.href = 'weixin://dl/business/?ticket=tacbd10b4e6bd04286adb8911518cd7c1';
}
...
<div class="mui-content">
	...
	<a href="https://www.zhihu.com/question/30179226">https://www.zhihu.com/question/30179226</a>
	
	<input type="button" value="打开微信 并且带入事件" onclick="go()">
</div>
